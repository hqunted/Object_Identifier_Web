  ...
  return (
    <>
      <div className="flex justify-center align-middle items-center w-screen h-screen 2xl:pb-2.5xl lg:pb-2.5xl md:pb-4xl sm:pb-3xl ">
        <div className="flex w-full 2xl:py-2xl lg:py-xl lg:w-1/2 md:py-2xl justify-center rounded-3xl transform bg-gradient-to-br from-blue-300 to-blue-600 shadow-lg">
